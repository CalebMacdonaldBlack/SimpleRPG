...
public class Poison extends Modifier{
	...
	public Poison(Main plugin, String name, double rate, int duration, Long interval, double intensity, String type,
	...
	public void applyBuff(Player player, Entity entity) {
		if(getTarget().equals("player")){
			if(getTrigger().equals("hold") || getTrigger().equals("have"))
				...
				player.addPotionEffect(new PotionEffect(PotionEffectType.POISON, getDuration()*20, (int) getIntensity()));
		}else{
